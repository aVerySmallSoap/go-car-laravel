...
<body>
    ...
    <div class="content">
        ...
        <div class="container-table">
            <table data-table="posttripreceipts">
                <thead>
                <tr>
                    <th>ID</th>
                    <th>Pretrip ID</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <form>
                                ...
                                <button type="submit" formaction="/receipt/post-trip/{{$element['pretrip_ID']}}">
    ...
    <script src="{{asset('/js/receipts/posttrip/search.js')}}"></script>
