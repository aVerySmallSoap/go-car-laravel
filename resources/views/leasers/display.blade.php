...
<body>
    ...
    <div class="content">
        <div class="container-search">
            <button class="btn" onclick="window.location.href='{{ route('leasers.create')}}'">Add a leaser</button>
    ...
    <script src="{{asset('/js/leasers/search.js')}}"></script>
