...
<body>
    ...
    <div class="content">
        <div class="container-search">
            <button class="btn" onclick="window.location.href='{{ route('agents.create')}}'">Add an agent</button>
    ...
    <script src="{{asset('/js/agents/search.js')}}"></script>
